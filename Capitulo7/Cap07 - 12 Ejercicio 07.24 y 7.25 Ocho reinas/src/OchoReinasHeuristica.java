 ...
 * @time 10:34:02 AM
 */
public class OchoReinasHeuristica {
 /**
     * Tablero de ajedrez
     */
     ...
     */
    public OchoReinasHeuristica(){
        tablero = new Tablero();
    }
    /**
     * Intenta colocar 8 reinas en un tablero de ajedrez
     * @return int Cantidad de reinas
     */
    public int colocarOchoReinas(){
        /**
         * mientras 
         */
        ...
        while(casillasOcupadas < 64){
            Reina reina = simularRecorridoReina();
    ...
    /**
     * Entrega una reina con la posicion en la que ocupa menos lugares en el tablero
     * @return reina
     */
     ...
     */
    private int contarLugaresReina(Reina reina){
     ...
     */
    private int contarLugaresHorizontal(Reina reina){
     ...
     * @return Lugares ocupados por la reina
     */
    private int contarLugaresVertical(Reina reina){
     ...
     */
    private int contarLugaresDiagonales(Reina reina){
     ...
     * @return cantidad de lugares ocupados por la reina
     */
    private int contarPendienteDecrecienteSuperior(Reina reina){
     ...
     */
    private int contarPendienteDecrecienteInferior(Reina reina){
     ...
     */
    private int contarPendienteCrecienteSuperior(Reina reina){
     ...
     * @return total de casillas cubiertas por la reina
     */
    private int contarPendienteCrecienteInferior(Reina reina){
