...
/**
 * La idea general sobre colocar 8 reinas en un tablero de ajedrez es ir eligiendo aquellas
 * posiciones donde la reina ocupe (abarque) la cantidad menor de casillas posible
 * @author eedua
 */
...
public class OchoReinas {
     ...
     * @return reina
     */
    public void recorridoReinaExhaustiva(Reina[] reinas, int cantidadReinas){
                for(int borrar = 0; borrar < retroceso; borrar++){
                     eliminarReina(reinas[cantidadReinas - borrar]);
                     reinas[cantidadReinas - borrar] = null;
                }
                cantidadReinas -= retroceso;//restar uno a cantidad de reinas colocadas
                retroceso++;
    }
